...
import { IFormLogin } from "../../interface/user/user.interface";
import {
  StyledBody_2_400,
  StyledBody_2_500,
  StyledHeading_5_500,
      ...
      <Section>
        ...
        <form onSubmit={handleSubmit(signInUser)}>
          ...
          <div className="password_container">
            ...
            />
            <BsEyeFill onClick={() => setViewPassword(!viewPassword)} />
          </div>
          ...
          <StyledButton_primary type="submit">Entrar</StyledButton_primary>
